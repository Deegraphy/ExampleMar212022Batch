...
public class BasicScenario6DemoTestNG {
	...
	@Test(priority = 5,dataProvider = "newProj")
	...
	@Test(priority = 6,dataProvider = "editproj")
	private static void modifyProject(String editproject) {
		try {
			obrowser.findElement(By.xpath("//*[@id=\'topnav\']/tbody/tr[1]/td[3]/a/div[1]")).click();
			Thread.sleep(1000);
			...
			Thread.sleep(1000);
			obrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys(editproject);
			Thread.sleep(3000);
	...
	private static void deletecustomer() {
		try {
			...
			Thread.sleep(3000);
			System.out.println("+++++++++++++++++++ END OF BASIC SCENARIO 6+++++++++++++++++++++");
	...
	@DataProvider(name="editproj")
	public Object[][] modprojedetails()
	{
		return new Object[][] {{"Hosa Project"}};
	}
