...
public class BasicScenario6Demo {
	...
	public static void createcustomer() {
		try {
			...
			Thread.sleep(1000);
			obrowser.findElement(By.xpath("//*[@id=\'customerLightBox_nameField\']")).sendKeys("Hosa Customer");
			Thread.sleep(1000);
	...
	public static void modifyProject() {
		try {
			...
			Thread.sleep(1000);
			obrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys("Hosa Project");
			Thread.sleep(1000);
